...
function RegClassS(cl: TPSPascalCompiler;
  const InheritsFrom, ClassName: string): TPSCompileTimeClass;
begin
...
begin
  cl.AddTypeS('TFieldType',
    '(ftUnknown, ftString, ftSmallint, ftInteger, ftWord, ftBoolean, ftFloat, ftCurrency, ftBCD, ftDate, ftTime, ftDateTime,'
    +
    'ftBytes, ftVarBytes, ftAutoInc, ftBlob, ftMemo, ftGraphic, ftFmtMemo, ftParadoxOle, ftDBaseOle, ftTypedBinary, ftCursor, ftFixedChar, ftWideString,' + 'ftLargeint, ftADT, ftArray, ftReference, ftDataSet, ftOraBlob, ftOraClob, ftVariant, ftInterface, ftIDispatch, ftGuid, ftTimeStamp, ftFMTBcd)');

  CL.AddTypeS('TDataSetState',
  ...
  cl.addTypeS('TFieldGetTextEvent',
...
{$ENDIF}
  ...
  cl.addTypeS('TDataSetErrorEvent',
